...
function initialState(rule?: Rule): FormState {
  return {
    ...
    conditionQuery: rule?.condition_query ?? null,
...
function formToPayload(form: FormState, status: "draft" | "published"): RuleCreate {
  return {
    ...
    condition_query: form.conditionQuery || null,
      ...
      <section className="space-y-3">
        ...
        <ConditionBuilder
          ...
          onChange={(u) => update({
            ...
            conditionQuery: "conditionQuery" in u ? u.conditionQuery : form.conditionQuery,
          })}
        />
      </section>
